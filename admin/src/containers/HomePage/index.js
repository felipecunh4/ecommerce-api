...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/felipecunh4/',
  },
];
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>Ao lado voce pode inserir diferentes jogos, categorias e publishers para nossa maravilhosa loja de jogos!</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>
                Em caso de duvidas ou sugestoes, so ir em algum de nossos links {"=)"}
              </P>
